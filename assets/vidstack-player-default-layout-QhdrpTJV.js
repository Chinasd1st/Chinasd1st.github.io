const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-BTigPj2h-D2j670E8.js","assets/vidstack-player-C4BX_DE9.js","assets/app-DTxLo1VT.js"])))=>i.map(i=>d[i]);
import{aH as h,o as V,aG as Dt,h as Mt,j as A,be as me,ai as T,g as I,ak as N,aE as ve,aA as fe,bf as v,bg as It,ag as he,aB as $e,w as g,C as be,bh as Ot,bi as ge,aq as ye,bj as xe,A as Se,bk as _t,aD as Pt,bl as Te,bm as K,q as lt,s as ke,ae as we,k as F,au as Ae,z as M,bn as Ce,aM as De,b2 as Lt,al as Gt,l as et,aP as Me,bo as Ie,bp as Oe,bq as _e,bd as Nt}from"./vidstack-player-C4BX_DE9.js";import{_ as Pe}from"./app-DTxLo1VT.js";import{A as O,T as Le,D as Tt,x as o,s as Ge,L as Bt}from"./vidstack-CwTj4H1w-DiaEMxg6.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const H={ATTRIBUTE:1,CHILD:2,BOOLEAN_ATTRIBUTE:4},q=e=>(...t)=>({_$litDirective$:e,values:t});let ut=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ot extends at{}ot.directiveName="unsafeSVG",ot.resultType=2;const Ne=q(ot);/**
 * @license
 ...
 */const B=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const l of i)(n=(s=l)._$AO)===null||n===void 0||n.call(s,t,!1),B(l,t);return!0},Q=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while(s?.size===0)},Vt=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),We(t)}};function Ee(e){this._$AN!==void 0?(Q(this),this._$AM=e,Vt(this)):this._$AM=e}function Re(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let l=s;l<n.length;l++)B(n[l],!1),Q(n[l]);else n!=null&&(B(n,!1),Q(n));else B(this,e)}const We=e=>{var t,s,n,i;e.type==H.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Re),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=Ee))};class Ft extends ut{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),Vt(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(B(this,t),Q(this))}setValue(t){if(Be(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}class Ke extends Ft{#t=null;#s=!1;#e=null;constructor(t){super(t),this.#s=t.type===H.ATTRIBUTE||t.type===H.BOOLEAN_ATTRIBUTE}render(t){return t!==this.#t&&(this.disconnected(),this.#t=t,this.isConnected&&this.#n()),this.#t?this.#i(Mt(this.#t)):O}reconnected(){this.#n()}disconnected(){this.#e?.(),this.#e=null}#n(){this.#t&&(this.#e=A(this.#o.bind(this)))}#i(t){return this.#s?rt(t):t}#a(t){this.setValue(this.#i(t))}#o(){this.#a(this.#t?.())}}function a(e){return q(Ke)(h(e))}class Et{#t;#s;elements=new Set;constructor(t,s){this.#t=t,this.#s=s}connect(){this.#n();const t=new MutationObserver(this.#e);for(const s of this.#t)t.observe(s,{childList:!0,subtree:!0});V(()=>t.disconnect()),V(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){me(t)?(s.textContent="",s.append(t)):(Tt(null,s),Tt(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}#e=Dt(this.#n.bind(this));#n(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=this.#t.flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&this.#s(this.elements)}}let He=0,W="data-slot-id";class Rt{#t;slots;constructor(t){this.#t=t,this.slots=new Et(t,this.#e.bind(this))}connect(){this.slots.connect(),this.#e();const t=new MutationObserver(this.#s);for(const s of this.#t)t.observe(s,{childList:!0});V(()=>t.disconnect())}#s=Dt(this.#e.bind(this));#e(){for(const t of this.#t)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(W);i||s.setAttribute(W,i=++He+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(W)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(W,i)}}}}function Qe({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return o`<svg
  ...
  `}function kt({tooltip:e,ref:t=Te}){const{translations:s}=u(),n=d(s,"Mute"),i=d(s,"Unmute");return o`
  ...
  `}function wt({backward:e,tooltip:t}){const{translations:s,seekStep:n}=u(),i=e?"Seek Backward":"Seek Forward",l=d(s,i);return o`
    <media-tooltip class="vds-seek-tooltip vds-tooltip">
      <media-tooltip-trigger>
        <media-seek-button
          ...
          aria-label=${l}
        >
          ${k(e?"seek-backward":"seek-forward")}
        </media-seek-button>
      </media-tooltip-trigger>
  ...
  `}function qt(){const{translations:e}=u(),{live:t}=v(),s=d(e,"Skip To Live"),n=d(e,"LIVE");return t()?o`
    ...
    ></media-captions>
  `}function C(){return o`<div class="vds-controls-spacer"></div>`}function zt(e,t){return o`
  ...
  `}function X({label:e=null,value:t=null,upIcon:s="",downIcon:n="",children:i,isMin:l,isMax:r}){const p=e||t,c=[n?k(n,"down"):null,i,s?k(s,"up"):null];return o`
    <div
  ...
  `}const us={...Ze,upIcon:"menu-opacity-up",downIcon:"menu-opacity-down"},$t={...Xe,upIcon:"menu-opacity-up",downIcon:"menu-opacity-down"};function ds(){return a(()=>{const{hasCaptions:e}=v(),{translations:t}=u();return e()?o`
      <media-menu class="vds-font-menu vds-menu">
        ...
        <media-menu-items class="vds-menu-items">
          ${[w({label:d(t,"Font"),children:[cs(),ps()]}),w({label:d(t,"Text"),children:[ms(),fs(),vs()]}),w({label:d(t,"Text Background"),children:[hs(),$s()]}),w({label:d(t,"Display Background"),children:[bs(),gs()]}),w({children:[ys()]})]}
        </media-menu-items>
      </media-menu>
  ...
  `}function J({label:e,checked:t,defaultChecked:s=!1,storageKey:n,onChange:i}){const{translations:l}=u(),r=n?localStorage.getItem(n):null,p=g(!!(r??s)),c=g(!1),$=a(Ae(p)),f=d(l,e);n&&i(Mt(p)),t&&A(()=>void p.set(t()));function m(x){x?.button!==1&&(p.set(L=>!L),n&&localStorage.setItem(n,p()?"1":""),i(p(),x),c.set(!1))}function b(x){Ce(x)&&m()}function y(x){x.button===0&&c.set(!0)}return o`
    <div
  ...
  `}function xs(){return a(()=>{const{translations:e}=u();return o`
    ...
    `})}function ws(){return a(()=>{const{translations:e}=u(),{audioTracks:t}=v(),s=d(e,"Default");return h(()=>t().length<=1)()?null:w({children:o`
      ...
      `})})}function As(){return a(()=>{const{noAudioGain:e,translations:t}=u(),{canSetAudioGain:s}=v();if(h(()=>!s()||e())())return null;const{audioGain:i}=v();return w({label:d(t,"Boost"),value:a(()=>Math.round(((i()??1)-1)*100)+"%"),children:[X({upIcon:"menu-audio-boost-up",downIcon:"menu-audio-boost-down",children:Cs(),isMin:()=>((i()??1)-1)*100<=Zt(),isMax:()=>((i()??1)-1)*100===Xt()})]})})}function Cs(){const{translations:e}=u(),t=d(e,"Boost"),s=Zt,n=Xt,i=Ds;return o`
  ...
  `}function ee({placement:e,portal:t,tooltip:s}){return a(()=>{const{viewType:n}=v(),{translations:i,menuPortal:l,noModal:r,menuGroup:p,smallWhen:c}=u(),$=h(()=>r()?K(e):c()?null:K(e)),f=h(()=>!c()&&p()==="bottom"&&n()==="video"?26:0),m=g(!1);es();function b(){m.set(!0)}function y(){m.set(!1)}const x=o`
    ...
    `})}function bt({orientation:e,tooltip:t}){return a(()=>{const{pointer:s,muted:n,canSetVolume:i}=v();if(s()==="coarse"&&!n())return null;if(!i())return kt({tooltip:t});const l=g(void 0),r=ge(l);return o`
      <div class="vds-volume" ?data-active=${a(r)} ${z(l.set)}>
        ${kt({tooltip:t})}
  ...
  `}function Es(){return a(()=>{const{live:e,duration:t}=v();return e()?qt():t()?o`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function se(){return a(()=>{const{live:e}=v();return e()?qt():Fs()})}function ne(){return a(()=>{const{textTracks:e}=T(),{title:t,started:s}=v(),n=g(null);return Pt(e,"chapters",n.set),n()&&(s()||!t())?ie():o`<media-title class="vds-chapter-title"></media-title>`})}function ie(){return o`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class ae extends qe{async loadIcons(){const t=(await Pe(async()=>{const{icons:n}=await import("./vidstack-BTigPj2h-D2j670E8.js");return{icons:n}},__vite__mapDeps([0,1,2]))).icons,s={};for(const n of Object.keys(t))s[n]=Qe({name:n,paths:t[n]});return s}}let Rs=class extends dt{static props={...super.props,when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576}};function Ws(){return[ct(),ft(),o`
    ...
    `]}function Ks(){return a(()=>{let e=g(void 0),t=g(!1),s=T(),{title:n,started:i,currentTime:l,ended:r}=v(),{translations:p}=u(),c=Ie(e),$=()=>i()||l()>0;const f=()=>{const y=r()?"Replay":$()?"Continue":"Play";return`${S(p,y)}: ${n()}`};A(()=>{c()&&document.activeElement===document.body&&s.player.el?.focus({preventScroll:!0})});function m(){const y=e(),x=!!y&&!c()&&y.clientWidth<y.children[0].clientWidth;y&&Oe(y,"vds-marquee",x),t.set(x)}function b(){return o`
      ...
      `}return Ot(e,m),n()?o`
          <span class="vds-title" title=${a(f)} ${z(e.set)}>
            ${[b(),a(()=>t()&&!c()?b():null)]}
          </span>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Us=q(class extends ut{constructor(){super(...arguments),this.key=O}render(e,t){return this.key=e,t}update(e,[t,s]){return t!==this.key&&(Fe(e),this.key=t),s}});class qs extends dt{static props={...super.props,when:({viewType:t})=>t==="video",smallWhen:({width:t,height:s})=>t<576||s<380}}function oe(){return a(()=>{const e=T(),{noKeyboardAnimations:t,userPrefersKeyboardAnimations:s}=u();if(h(()=>t()||!s())())return null;const i=g(!1),{lastKeyboardAction:l}=e.$state;A(()=>{i.set(!!l());const m=setTimeout(()=>i.set(!1),500);return()=>{i.set(!1),window.clearTimeout(m)}});const r=h(()=>{const m=l()?.action;return m&&i()?F(m):null}),p=h(()=>`vds-kb-action${i()?"":" hidden"}`),c=h(zs),$=h(()=>{const m=js();return m?_e(m):null});function f(){const m=$();return m?o`
