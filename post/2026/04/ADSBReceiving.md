...
因为 homepos 没有正确设置或设置错误，导致程序认为所有接收到的飞机位置都“太远”。
...
`--interactive` 参数开启了交互模式，访问<http://localhost:8080/index.html>即可打开 Tar1090。
...
得出天线最佳长度应为 6 ~ 7cm。由于家里没有合适的同轴线，暂且用 25cm 的天线替代。天线必须垂直竖立放置，倾斜或平放会造成信号剧烈衰减，导致几乎无法接收信号。
