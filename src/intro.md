...
<div style="display: flex; flex-direction: column; align-items: center; gap: 2.5rem; margin: 2rem 0 4rem;">
  ...
  <a href="https://github.com/anuraghazra/github-readme-stats" target="_blank" rel="noopener noreferrer">
    <img
      ...
      alt="GitHub Stats"
      style="max-width: 480px; height: auto; border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,0.08); transition: transform 0.3s;"
  ...
  <a href="https://github.com/anuraghazra/github-readme-stats" target="_blank" rel="noopener noreferrer">
    <img
      ...
      alt="Top Languages"
      style="max-width: 380px; height: auto; border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,0.08); transition: transform 0.3s;"
    />
  </a>
</div>
