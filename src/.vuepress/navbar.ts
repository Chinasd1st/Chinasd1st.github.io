    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { text: "[已脱敏]b站收藏夹标签统计", link: "/post/2025/07/LCYBilibiliFavoritesStatistics.html", icon: "tag" },
          { text: "[已脱敏]偷偷OD泰诺后不慎睡着了", link: "/post/2025/07/WHYODTylenol.html", icon: "pills" }
        ],
      },
      {
        text: "2025.08",
        children: [
          ...
          { text: "[已脱敏]不看网课", link: "/post/2025/08/LCYSchoolWork.html", icon: "person-chalkboard" },
          { text: "[已脱敏]军训实录", link: "/post/2025/08/MilitaryTraining.html", icon: "person-military-rifle" },
      ...
      },
      {
        text: "2026.01",
        children: [
          { text: "[已脱敏]幽默事件", link: "/post/2026/01/HumorousIncidents.html", icon: "user-tie" }
        ],
      }
    ],
  },
    ...
    children: [
      {
        text: "订阅格式",
        children: [
          { text: "RSS 2.0", link: "./rss", icon: "rss" },
          { text: "Atom 1.0", link: "./atom", icon: "atom" },
          { text: "JSON Feed", link: "./feed", icon: "file-code" }
        ],
      },
    ],
  },
